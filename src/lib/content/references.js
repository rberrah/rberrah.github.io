...
export const referenceGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'bauer-nonmem-1', kind: 'article', title: 'NONMEM Tutorial Part I: description of commands and options, with simple examples of population analysis', authors: 'Bauer R.J.', where: 'CPT: PSP 2019', doi: '10.1002/psp4.12404', pmid: '30810274', url: 'https://doi.org/10.1002/psp4.12404' },
      { id: 'bauer-nonmem-2', kind: 'article', title: 'NONMEM Tutorial Part II: estimation methods and advanced examples', authors: 'Bauer R.J.', where: 'CPT: PSP 2019', doi: '10.1002/psp4.12422', pmid: '31056869', url: 'https://doi.org/10.1002/psp4.12422' },
      { id: 'lavielle-mentre-monolix', kind: 'article', title: 'Estimation of population pharmacokinetic parameters of saquinavir in HIV patients with the MONOLIX software', authors: 'Lavielle M. & Mentré F.', where: 'J. Pharmacokinet. Pharmacodyn. 2007', doi: '10.1007/s10928-006-9043-z', pmid: '17206526', url: 'https://doi.org/10.1007/s10928-006-9043-z' },
      { id: 'delyon-saem', kind: 'article', title: 'Convergence of a stochastic approximation version of the EM algorithm (le fondement mathématique du SAEM)', authors: 'Delyon B., Lavielle M. & Moulines E.', where: 'Ann. Statist. 1999', doi: '10.1214/aos/1018031103', url: 'https://doi.org/10.1214/aos/1018031103' },
      { id: 'wang-rxode', kind: 'article', title: 'A Tutorial on RxODE: simulating differential equation pharmacometric models in R', authors: 'Wang W., Hallow K.M. & James D.A.', where: 'CPT: PSP 2016', doi: '10.1002/psp4.12052', pmid: '26844010', url: 'https://doi.org/10.1002/psp4.12052' }
    ]
  },
  {
    id: 'tdm',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'rybak-vanco', kind: 'guideline', title: 'Vancomycin therapeutic monitoring: AUC-guided consensus guideline (AUC₂₄/MIC 400–600 in the target setting)', authors: 'Rybak M.J. et al.', where: 'Am. J. Health-Syst. Pharm. 2020', doi: '10.1093/ajhp/zxaa036', pmid: '32191793', url: 'https://doi.org/10.1093/ajhp/zxaa036' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'fda-be-statistical-2026', kind: 'guideline', title: 'Statistical Approaches to Establishing Bioequivalence', authors: 'U.S. FDA', where: 'Final guidance, May 2026', url: 'https://www.fda.gov/regulatory-information/search-fda-guidance-documents/statistical-approaches-establishing-bioequivalence' },
      ...
      { id: 'ich-m15', kind: 'guideline', title: 'ICH M15 — General Principles for Model-Informed Drug Development', authors: 'ICH / U.S. FDA', where: 'Final guidance, June 2026', url: 'https://www.fda.gov/regulatory-information/search-fda-guidance-documents/m15-general-principles-model-informed-drug-development' },
