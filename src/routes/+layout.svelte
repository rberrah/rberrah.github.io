...
<div class="app">
  ...
  <footer>
    <span>Pharmacométrie Explain · Text CC-BY-SA · Code MIT · 2026</span>
    <span class="muted">Built with SvelteKit · static, no tracking</span>
  </footer>

  <div class="disclaimer" data-testid="educational-disclaimer" role="note">
    Educational content only. Not medical advice. No patient-specific dosing.
  </div>
</div>
