// =========================================================================
// genta_evers_standard.cpp -- Gentamicin, adult general ward
//                             (van Lent-Evers & Vinks 1995, "standard" model)
//
// SOURCE
//   van Lent-Evers NAEM, Vinks AATMM, 1995 -- the "standard" (non-ICU)
//   gentamicin model, the default for gentamicin dosing in the Netherlands.
...
//
// POPULATION
//   Dutch adult NON-ICU general-ward patients. This is the most GENERAL adult
//   population in the family and, of the three, the closest to an orthopaedic
//   ward. It is the reference model to prefer for a PJI cohort.
//
...
//       If this model is used in the headline results, the 1995 paper should
//       be obtained and the values checked against it.
//     - The lowest Vd coefficient of the family (0.273 against 0.312 and
//       0.335), consistent with a ward population without the fluid overload
//       of intensive care.
//     - The widest IIV on fr in the family (CV 65%), which is what a
//       heterogeneous general-ward population should look like.
//
//   SMOKE EXPECTATION
//     80 kg / 175 cm / 65 y male, CREAT 80 umol/L, 400 mg over 30 min:
//     CL 4.27 L/h, V 20.3 L, peak 19.7 mg/L, t1/2 3.29 h, C24 0.13 mg/L.
// =========================================================================
...
$PARAM @annotated
TVCLM : 0.225 : Non-renal clearance at 70 kg (L/h)
TVFR  : 0.727 : Renal clearance as a fraction of CLcr (dimensionless)
TVVD  : 0.273 : Volume coefficient (L/kg of corrected lean body mass)
...
// ETA1 CLm : SD 0.113 / mean 0.225 = 50.2% -> ln(1+CV^2) = 0.2249
// ETA2 fr  : SD 0.471 / mean 0.727 = 64.8% -> ln(1+CV^2) = 0.3505
// ETA3 Vd  : SD 0.082 / mean 0.273 = 30.0% -> ln(1+CV^2) = 0.0864
$OMEGA 0.2249 0.3505 0.0864
