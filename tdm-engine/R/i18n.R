...
APP_TRANSLATIONS <- c(
  ...
  "L'artefact actuellement déployé concerne le modèle Revilla de vancomycine IV intermittente et exige une administration à l'état stationnaire (ss = 1). Un seul épisode de TDM suffit s'il contient au moins deux concentrations dans un même intervalle posologique; cet intervalle n'a pas besoin d'être le plus récent. Les deux concentrations les plus récentes de l'intervalle admissible le plus récent alimentent le prédicteur." = "The currently deployed artifact covers the Revilla intermittent-IV vancomycin model and requires an administration declared at steady state (ss = 1). One TDM occasion is sufficient when it contains at least two concentrations in the same dosing interval; that interval does not need to be the latest one. The two latest concentrations from the latest eligible interval feed the predictor.",
